    ...
    $.fn.orbit = function(options) {
        ...
        return this.each(function() {
            ...
            if(options.captions) {
                ...
                function setCaption() {
                    var _caption = '<a href="'+images.eq(activeImage).attr('href')+'" target="'+images.eq(activeImage).attr('linktarget')+'">'+images.eq(activeImage).attr('caption')+'</a>'+'<span>'+images.eq(activeImage).attr('price')+'</span>';
